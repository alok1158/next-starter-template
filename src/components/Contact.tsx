...
const Contact = () => {
  return (
    <div id="contact" className="w-full lg:h-fit">
      <section className="bg-contactImg bg-opacity-0 h-screen w-full">
        <div className="py-8 lg:pt-8 px-4 mx-auto max-w-screen-md">
          <h2 className="mb-4 mt-10 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">
            Contact Us
          </h2>
          <p className="mb-8 lg:mb-5 font-light text-center text-gray-400 dark:text-gray-700 sm:text-lg">
            Got a technical issue? Want to send feedback about a beta feature?
            Need details about our Business plan? Let us know.
          </p>
          <form action="#" className="space-y-5 md:space-y-2 bg-white bg-opacity-50 rounded-2xl p-5">
            <div>
              <label
                htmlFor="email"
